...
FILEPATH = "/Users/kimhyeongjin/Desktop/23F/Warehouse_Robot_Path_Planning-master/"
 ...
 # break while loop when end of this episode
            ...
            if (done1 == 'hit' or done1 == 'arrive') and (done2 == 'hit' or done2 == 'arrive') and (done3 == 'hit' or done3 == 'arrive'):
                ...
                if episode == 80:
                    ...
                    print(f"Episode 80 elapsed time: {elapsed_time} seconds")
                if episode == 250:
                    end_time = time.time()
                    elapsed_time = end_time - start_time
                    print(f"Episode 130 elapsed time: {elapsed_time} seconds")                    
...
def learn (episode, RL, action, reward, observation, observation_):
     if episode < 500:
         RL.learn(str(observation), action, reward, str(observation_), 0.01, 0.9)
